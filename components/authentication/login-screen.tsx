...
import { authSchema, type AuthValues } from "@/schema/auth-schema"
...
export function LoginScreen() {
  ...
  const showVerification =
    unverifiedEmail !== "" &&
    emailValue.trim().toLowerCase() === unverifiedEmail.toLowerCase()
  ...
  async function sendVerification() {
    if (!unverifiedEmail || resending || resendIn > 0) return
        ...
        <div className="flex flex-1 flex-col justify-center py-8">
          ...
          <header className="mb-8 text-center">
            <h1 className="text-2xl font-medium tracking-tight">
              Never forget what you lifted
            </h1>
            <p className="mt-3 text-sm text-balance text-muted-foreground">
              Repo remembers every set and shows your year as a grid.
            </p>
          </header>
            ...
            {showVerification ? (
              <div className="flex flex-col gap-3">
                ...
                <Button
                  ...
                  className="h-12 min-h-11 w-full text-base tabular-nums shadow-none"
